...
public class WARDirContext extends BaseDirContext {
     ...
     * @throws javax.naming.NameAlreadyBoundException if newName is already
     *                                                bound
     ...
     *               be null
     * @throws javax.naming.directory.AttributeModificationException if the
     ...
     *                                                           bound
     * @throws javax.naming.directory.InvalidAttributesException if some
     ...
     * @throws javax.naming.NameAlreadyBoundException            if name is already
     *                                                           bound
     * @throws javax.naming.directory.InvalidAttributesException if attrs
     ...
     * @throws javax.naming.directory.InvalidSearchFilterException   if the
     *                                                               search filter specified is not supported or understood by the underlying
     *                                                               directory
     * @throws javax.naming.directory.InvalidSearchControlsException if the
     ...
     * @throws javax.naming.directory.InvalidSearchControlsException if cons
     *                                                               contains invalid settings
     * @throws javax.naming.directory.InvalidSearchFilterException   if
